...
Please complete an effective visualization of amounts using the tidykids data with a bar (i.e., column) chart, keeping in mind the aforementioned considerations. Then, add 1-2 sentences interpreting your visualization.  Like last week, please let the open-endedness be fun, not a burden. 
