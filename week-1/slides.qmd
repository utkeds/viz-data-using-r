...
- Many ways to get help:
  ...
  2. PingPong AI, ChatGPT, etc. (see syllabus for policy)
  3. Email
...
- In [Canvas](https://utk.instructure.com/courses/213032) there is a zip file for `week-1` with all the files you need.
...
- You save an R script and submit it as it is
  - Not true with R Markdown files
...
## R Markdown - Code Chunks {.smaller}
<hr>

- Another part of an R Markdown document is the **code chunks**.

:::{layout="[50,50]"}
![](setup_chunk.png)<br>[Setup Chunk in a `.Rmd`]{.small-font}
<br>
<br>
![](RMarkdownCodeChunkExample.png)<br>[Code Chunk in a `.Rmd`]{.small-font}

::::{.extra-small-font}
You can use chunk options at the beginning of an `.Rmd` to establish defaults for the full document.
<br>
<br>
...
**Body Chunks:** You can  name the chunks (makes for better error messages) and override code chunk defaults.
...
## R Markdown - Knitting Errors {.smaller}
<hr>
...
- Starting next week...
- We focus on `.html` files because Canvas can read them and they support interactive plots

## R Markdown - Plain Text - Activity {.smaller}
<hr>
...
- In the `week-1` folder you will find the file for the activity called `R Markdown: In-Class Activity`.
