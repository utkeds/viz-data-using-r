...
:::{.smaller-font}
- In your R studio settings, you can toggle which pipe the keyboard shortcut uses.
- 'Ctrl + Shift + M' or 'Cmd + Shift + M' will give you the pipe.
- Decide which pipe it outputs in Tools > Global Options > Code > Editing
- Tick "Use native pipe operator"
...
# [Mini-Project #2](https://utk.instructure.com/courses/213032/assignments/1933661)
...
- Reading:
    ...
    - Chang (2024), Ch. 11
    - R Coder (2024)
- Assignment 9: Creating Visualizations and Modifying Textual Components
- Begin thinking about data/viz plan for final project (mini-project #2)
