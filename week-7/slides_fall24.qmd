...
<!-- ```{r} -->
<!-- #pivot the wider data to longer to match original tidykids -->

<!-- longer <- wider |> -->
<!--   pivot_longer( -->
<!--     cols = (starts_with(c("raw", "inf_adj", "inf_adj_perchild"))),  # Target all the wide columns -->
<!--     names_to = c(".value", "variable"),  # Retain 'raw', 'inf_adj', and 'inf_adj_perchild' as columns -->
