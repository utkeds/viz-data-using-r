...
- You can also add titles, customize the layout of the combined plots, and adjust the legend, when appropriate
...
<hr>
:::{.smaller-font}
- Let's add a title to the whole figure
```{r, fig.height=4.5}
...
- {cowplot} is older and [written by Wilke](https://wilkelab.org/cowplot/articles/plot_grid.html)
