...
Again using a previous data set and related analyses and/or visualizations, add two or more annotation layers to a plot OR use gghighlight (counts as one of two annotations).
...
Important note: After you render, check the HTML file. 

- Does it appear as you intended?

Share any questions you have in Canvas about fine-tuning your .qmd output.
