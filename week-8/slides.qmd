...
Outside of `aes()`, `fill` maps to the geometry, *not* the data.
...
You can specify colors for specific values using `scale_fill_manual` and a named vector **as long as `fill` are mapped to the data**:
