...
All of this is easy to do with `ggplot`!
]
...
We will do more work with text *as part of a visualization*.

However, before doing so, let's work with **text as a part of the data**.

## Week 9 - Text Activities - Student.Rmd
...
What's one thing you took away from this week