...
<!-- Related folder on Google Drive: https://drive.google.com/drive/folders/17rMsft9XuGpvK4A8R0eGl3Nt3JkUJp43 -->
...
---
<!-- Include personal introduction here -->
...
---
background-image: url(https://learningsolutionsmag.com/sites/default/files/inline-images/7441_Figure2.png)
class: bottom, center
...
- An R project somewhere on your computer called "STEM 531 - Data Visualization in R"
--
...
--
- install key R packages using `install.package()`,
--
...
3. On the continuum between pure visual imagery and pure writing, where does data visualization fit?
4. In what ways does Healy's information align with Cairo's? 
5. Think back to the "What's wrong with this viz" activity. How is it related to Cairo's 5 steps to reading a data visualization?
6. How would you amend (if at all) Cairo's 5 steps to reading a visualization based on the information Healy presents?
</small>
]
