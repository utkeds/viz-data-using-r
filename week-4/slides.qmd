...
- In your `.zip` file, you have a `tidykids.R` script. Open it.
  - We'll work through the script together.
...
3. Example: I am only interested in the data from 2016. How would I filter for this?
4. Example: I want to create a new variable that groups states by region. How would I do this?
5. Example: I want to summarize the data by region. How would I do this?
6. Example: I am only interested in library expenditures. How would I filter for this?
:::
