...
.pull-right[
### `head(starwars)`
Use this to **see the first 10 (or more) rows**
...
.pull-left[
We can add other layers. Let's go crazy and make a *bad plot*:
...
Using the `tidykids` dataset, you will ake a simple bar chart showing which category of spending per chuld has been highest, on average, for Tennessee.
