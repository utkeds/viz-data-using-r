...
# R Fundamentals - What the heck is `|>` or `%>%` ?

The pipe operator `|>` or `%>%` connects functions together into a *chain* of step-by-step commands. It can be translated as **and then**.
