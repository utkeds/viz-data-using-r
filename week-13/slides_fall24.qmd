...
::: {.callout-tip}
The [ussf](https://github.com/dcl-docs/ussf) package handles the AK/HI problem for nationwide US mapping.
:::
...
ggplot() +
  ...
  geom_sf(data = knox_sites_sf, color = "orange")
```
