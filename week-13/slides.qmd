...
#| out.width: 60%
#| fig-align: center
knitr::include_graphics("~/R/viz-data-using-r/week-13/early-world-map.jpg")
```
...
#| out.width: 60%
#| fig-align: center
knitr::include_graphics("~/R/viz-data-using-r/week-13/airbnb-occupancy-eclipse.png")
```
...
#| out.width: 60%
#| fig-align: center
knitr::include_graphics("~/R/viz-data-using-r/week-13/heatmap_2x.png")
```
...
#| out.width: 60%
#| fig-align: center
knitr::include_graphics("~/R/viz-data-using-r/week-13/knox.png")
```
...
#| out.width: 60%
#| fig-align: center
knitr::include_graphics("~/R/viz-data-using-r/week-13/files.png")
```
...
#| out.width: 60%
#| fig-align: center
knitr::include_graphics("~/R/viz-data-using-r/week-13/photo.png")
```
...
```{r}
ggplot(joined_data, aes(x = long, y = lat, group = group, fill = value)) +
  geom_polygon() +
  coord_quickmap()
```
