...
- I use the [{ussf} package](https://github.com/dcl-docs/ussf) for my US states shapefile
...
library(viridis) # You shouldn't need this, but my slides were being difficult
